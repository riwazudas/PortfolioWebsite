          ...
          <div className="w-64 overflow-hidden flex flex-col">
            {jobs.map((job, index) => (
              <button
                ...
                className={`relative text-left p-4 w-full text-sm font-medium border-b-2 md:border-b-0 md:border-l-2 transition-colors ${
                  activeTab === index
              ...
              >
                <div className="overflow-hidden whitespace-nowrap group">
                  <div className="inline-block group-hover:animate-marquee">
                    {job.company}
                  </div>
                </div>
              </button>
